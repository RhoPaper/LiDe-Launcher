#本版本纯血天启启动器(Tian-Qi-Launcher)套壳版，以后再大幅度改动
#下个版本加UI
...
# 启动器主程序
clear()#清除程序开始部分的内容
colorprint('LiDe启动器Alpha，一款暂无UI的Minecraft启动器.',"blue")
print("")
...
clear()
print('\033[0;33;40m[关于作者]\033[0m \033[0;36;40m作者\033[0m : Lion_Deer\033[0m , \033[0;33;40mQQ: 2964774820\033[0m ')
print("")
print('\033[1;31;40m [ 重 要 提 醒 ] \033[0m \033[0;31;40m以后不需要打开此启动器重新下载和打开，否则会出错(作者懒得编检测代码)\n启动器会自动生成开服脚本在文件夹里(如1.8.8服务器在1_8_8文件夹里，里面有"开服务器.bat"，双击启动)\033[0m')
time.sleep(3)
print("")
